...
- La sincronizacion con Riot se dispara desde la app: boton «Sincronizar todo» y un intervalo en el dashboard (`DashboardBackgroundSync`, cada 30 minutos por defecto, sobreescribible con `NEXT_PUBLIC_DASHBOARD_RIOT_SYNC_MINUTES`) solo mientras la pestana esta abierta; sin cron en repo.
