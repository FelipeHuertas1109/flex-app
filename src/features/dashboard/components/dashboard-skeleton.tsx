    ...
    <AppShell>
      <div className="space-y-6" aria-label="Cargando dashboard">
        <section className="grid gap-4 lg:grid-cols-[minmax(0,1.55fr)_minmax(320px,0.8fr)]">
          <div className="overflow-hidden rounded-lg border border-border/80 bg-surface/94 p-5 shadow-lg shadow-teal/5 sm:p-6">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
              {Array.from({ length: 4 }).map((_, index) => (
                <div className="rounded-lg border border-border/80 bg-white/80 p-4" key={index}>
        ...
        <section className="grid gap-4 xl:grid-cols-[minmax(0,1.35fr)_minmax(340px,0.8fr)]">
          <Panel className="overflow-hidden">
            <div className="flex items-start justify-between gap-3 border-b border-border/80 p-5">
              <div>
            ...
            <div className="hidden md:block">
              {Array.from({ length: 5 }).map((_, index) => (
                <div className="grid grid-cols-6 gap-4 border-b border-border/70 p-5" key={index}>
