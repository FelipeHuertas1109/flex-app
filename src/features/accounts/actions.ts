...
async function syncRiotAccountById(
  ...
  const { error } = await adminSupabase
    ...
    .update({
      ...
      solo_tier: stats.soloTier,
      solo_rank: stats.soloRank,
      solo_lp: stats.soloLp,
      solo_win_rate: stats.soloWinRate,
      flex_tier: stats.flexTier,
      flex_rank: stats.flexRank,
      flex_lp: stats.flexLp,
      flex_win_rate: stats.flexWinRate,
